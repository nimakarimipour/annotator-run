 ...
 * system this {@link IFixedPointStatement}is part of (x represents the left-hand side of the
 * constraint). The interpretation of term (the right-hand side of the constraint) must be monotone.
 *
 * <p>The list of free variables in term is obtained by invoking {@link #getRHS()}, and the left
 * hand side variable is obtained by calling {@link #getLHS()}. Intuitively, a statement definition
...
public interface IFixedPointStatement<T extends IVariable<T>> extends INodeWithNumber {
   ...
   *
   * <ul>
   *   <li>{@link FixedPointConstants#CHANGED},
   *   <li>{@link FixedPointConstants#CHANGED_AND_FIXED},
   *   <li>{@link FixedPointConstants#NOT_CHANGED}, or
