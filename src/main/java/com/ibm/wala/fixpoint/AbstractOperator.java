 ...
 *
 * <p>This is an abstract class and not an interface in order to force subclasses to re-implement
...
public abstract class AbstractOperator<T extends IVariable<T>> implements FixedPointConstants {
   ...
   *
   * @return a code that indicates: 1) has the lhs value changed? 2) has this equation reached a
