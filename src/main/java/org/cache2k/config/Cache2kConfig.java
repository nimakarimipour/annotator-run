...
public class Cache2kConfig< K,  V>
  ...
  @Nullable private  CustomizationSupplier<? extends ExceptionPropagator<K, V>> exceptionPropagator;
  ...
  @Nullable public  CustomizationSupplier<? extends ExceptionPropagator<K, V>> getExceptionPropagator() {
  ...
  @Nullable private  Duration durationCheckAndSanitize( Duration v) {
    if (v == null) {
      return null;
    }
    if (v.isNegative()) {
